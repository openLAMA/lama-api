...
namespace Elyon.Fastly.Api.Controllers
{
    ...
    public class AuthorizeController : ControllerBase
    {
        ...
        public AuthorizeController(IAuthorizeService authService)
        {
        ...
        public async Task<ActionResult<JWTokenDto>> ConfirmLogin(UserConfirmationSpecDto confirmationSpecDto)
        {
            ...
            var jwtToken = await _authService
                .ConfirmLoginAsync(confirmationSpecDto.ConfirmationToken)
                .ConfigureAwait(false);
