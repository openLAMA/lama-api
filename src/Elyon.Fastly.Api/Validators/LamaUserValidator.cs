...
{
    public class LamaUserValidator : AbstractValidator<LamaUserDto>
    {
        public LamaUserValidator()
        {
            RuleFor(x => x.SupportDefaultOrganizationTypes.Select(e => e.OrganizationTypeId))
                   .Must(o => CheckForDuplicates(o))
                   .WithMessage("There shouldn't be duplicated organization types");
        }
