...
namespace Elyon.Fastly.Api.PostgresRepositories.Migrations
{
    ...
    [Migration("20220822084614_UpdateOrgDataPassword")]
    partial class UpdateOrgDataPassword
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Elyon.Fastly.Api.PostgresRepositories.Entities.CantonWeekdaysSamples", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("FridaySamples")
                        .HasColumnType("integer");

                    b.Property<int>("MondaySamples")
                        .HasColumnType("integer");

                    b.Property<int>("ThursdaySamples")
                        .HasColumnType("integer");

                    b.Property<int>("TuesdaySamples")
                        .HasColumnType("integer");

                    b.Property<int>("WednesdaySamples")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CantonWeekdaysSamples");
                });
            ...
            modelBuilder.Entity("Elyon.Fastly.Api.PostgresRepositories.Entities.FixedTestingPersonnelCancelation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("FixedTestingPersonnelCancelations");
                });
            ...
            modelBuilder.Entity("Elyon.Fastly.Api.PostgresRepositories.Entities.Organization", b =>
                {
                    ...
                    b.Property<string>("DataPassword")
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("IsContractReceived")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsOnboardingEmailSent")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsStaticPooling")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("ReportingContact")
                        .HasColumnType("text");

                    b.Property<string>("ReportingEmail")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Elyon.Fastly.Api.PostgresRepositories.Entities.TestingPersonnelConfirmationsWithoutInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TestingPersonnelConfirmationsWithoutInvitation");
                });
            ...
            modelBuilder.Entity("Elyon.Fastly.Api.PostgresRepositories.Entities.CantonWeekdaysSamples", b =>
                {
                    b.HasOne("Elyon.Fastly.Api.PostgresRepositories.Entities.Canton", "Canton")
                        .WithOne("CantonWeekdaysSamples")
                        .HasForeignKey("Elyon.Fastly.Api.PostgresRepositories.Entities.CantonWeekdaysSamples", "CantonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Elyon.Fastly.Api.PostgresRepositories.Entities.FixedTestingPersonnelCancelation", b =>
                {
                    b.HasOne("Elyon.Fastly.Api.PostgresRepositories.Entities.User", "CanceledByUser")
                        .WithMany("FixedTestingPersonnelCancelations")
            ...
            modelBuilder.Entity("Elyon.Fastly.Api.PostgresRepositories.Entities.TestingPersonnelConfirmationsWithoutInvitation", b =>
                {
                    b.HasOne("Elyon.Fastly.Api.PostgresRepositories.Entities.TestingPersonnel", "TestingPersonnel")
                        .WithMany("TestingPersonnelConfirmationsWithoutInvitations")
                        .HasForeignKey("TestingPersonnelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Elyon.Fastly.Api.PostgresRepositories.Entities.Canton", b =>
                {
                    b.Navigation("CantonWeekdaysSamples");
            ...
            modelBuilder.Entity("Elyon.Fastly.Api.PostgresRepositories.Entities.TestingPersonnel", b =>
                {
                    b.Navigation("FixedTestingPersonnelCancelations");

                    b.Navigation("TestingPersonnelConfirmations");

                    b.Navigation("TestingPersonnelConfirmationsWithoutInvitations");
