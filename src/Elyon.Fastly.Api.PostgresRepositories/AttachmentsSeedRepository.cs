...
{
    public class AttachmentsSeedRepository : BaseRepository, IAttachmentsSeedRepository
    {
        public AttachmentsSeedRepository(Prime.Sdk.Db.Common.IDbContextFactory<ApiContext> contextFactory, IMapper mapper)
        ...
        public async Task<AttachmentsSeedDto> GetFirstAsync()
        {
            ...
            return await context.AttachmentsSeeds
                .Select(a => new AttachmentsSeedDto { Id = a.Id, IsSeeded = a.IsSeeded })
                .FirstOrDefaultAsync()
        ...
        public async Task UpdateAsync(AttachmentsSeedDto dto)
        {
            ...
            var entity = await context.AttachmentsSeeds
                .Where(a => a.Id == dto.Id)
                .FirstOrDefaultAsync()
                .ConfigureAwait(false);
