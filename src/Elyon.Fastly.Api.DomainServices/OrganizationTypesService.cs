...
{
    public class OrganizationTypesService : BaseService, IOrganizationTypesService
    {
        private readonly IOrganizationTypesRepository _organizationTypesRepository;

        public OrganizationTypesService(IOrganizationTypesRepository organizationTypesRepository)
        {
